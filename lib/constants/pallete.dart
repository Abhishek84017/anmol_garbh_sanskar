...
class Palette {
  ...
  // Primary color
  static const MaterialColor primaryColor = MaterialColor(0xfff008d93, primaryColorSwatch);

  // Input background colors
  static const Color BackGroundColor = Color(0xfff7fb41c);

  static const Color textWhiteColor = Color(0xfffffffff);

  static const Color bottombarcolor = Color(0xfff008d93);
